  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-dark-50 tracking-tight leading-tight">Dashboard</h1>
          <p className="text-gray-600 dark:text-dark-200 text-base mt-1">Welcome back, {user?.name}</p>
        </div>
      ...
      <section>
        <div className="flex items-center mb-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900 dark:text-dark-100 tracking-tight leading-tight">Live Now</h2>
        </div>
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-dark-100 tracking-tight leading-tight">Your Rooms</h2>
            </div>
            <button
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-dark-100 tracking-tight leading-tight">Upcoming Events</h2>
            </div>
            <button
