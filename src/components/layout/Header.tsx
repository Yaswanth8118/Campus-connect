...
const Header: React.FC = () => {
  ...
  return (
    <motion.header
      className="bg-white/95 dark:bg-dark-950/95 backdrop-blur-xl shadow-lg dark:shadow-dark-lg border-b border-gray-200/50 dark:border-dark-700/80 sticky top-0 z-30"
      initial={{ y: -100 }}
      animate={{ y: 0 }}
